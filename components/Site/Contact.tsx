...
const Contact: FunctionComponent<DarkProps> = ({ dark }) => {
  ...
  const handleEmailTries = () => {
    ...
    if (typeof window !== "undefined") {
      tries = parseInt(window.localStorage.getItem("emailTries") || "0", 10);
      if (tries < 0) {
        tries = 0;
          ...
          <div className="md:tw-grid-cols-2 lg:tw-grid-cols-1 xl:tw-grid-cols-2 tw-grid">
            <div className=" tw-col-span-1 tw-flex tw-flex-col tw-gap-4">
              <div className="">
                ...
                <h1 className="tw-text-3xl">Frontend und Backend Entwickler</h1>
              </div>
              <div className=" tw-justify-between tw-h-full tw-flex tw-flex-col tw-gap-4">
                ...
                <div className="tw-flex tw-gap-8">
                  <Link
                    href={"https://www.linkedin.com/in/pascal-burri-72b12329a/"}
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    <Image
                      width={48}
                      height={48}
                      src={dark ? linkedInIcon : linkedInIconDark}
                      alt="linkedIn Icon"
                      style={{
                        maxWidth: "100%",
                        height: "auto",
        ...
        <div className="glass-pannel tw-shadow-2xl lg:tw-col-span-1 tw-self-center tw-grid tw-grid-rows-5">
          ...
          <div className="tw-text-left tw-w-full tw-h-full tw-row-span-4">
            <form
              ...
              ref={form}
            >
              <label htmlFor="user_name" className="tw-text-lg tw-font-medium">
                Dein Name:
              </label>
              <input
                type="text"
              ...
              />
              <label htmlFor="user_email" className="tw-text-lg tw-font-medium">
              ...
              <input
                ...
                name="user_email"
                className={`tw-rounded-xl tw-py-2 tw-px-3 tw-placeholder-gray-400 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-violet-600 tw-text-black ${loading || formState === "success" || formState === "userFault" ? "tw-bg-neutral-300 dark:tw-bg-neutral-600" : ""}`}
                placeholder={errors.email || "max-mustermann@mail.com"}
                disabled={
                  loading ||
                  formState === "success" ||
                  formState === "userFault"
              ...
              />
              <label htmlFor="message" className="tw-text-lg tw-font-medium">
                Deine Nachricht:
              </label>
              <textarea
                id="message"
