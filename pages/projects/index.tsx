					...
					<div className="lg:tw-col-span-3 tw-col-span-1">
						<div className="glass-pannel tw-h-full tw-grid md:tw-grid-cols-3 tw-grid-cols-1">
							<div className="md:tw-col-span-2 tw-col-span-1 tw-flex tw-flex-col">
								...
								<div className="">
									<p className="text-small tw-font-light tw-text-left tw-mb-4">
										Dies war mein erstes Projekt, welches
										ich von einem &quot;Privatkunden&quot;
										erhalten habe. Es handelt sich um eine
										einfache Gallerie für die Flugbilder
										meines Vaters. Für diese Seite habe ich
										ein Template von Vercel für die Gallerie
										verwendet, es auf meine Bedürfnisse
										angepasst und den Rest der Website
										designed und entwickelt. Die Seite wurde
										mit Next.js und TailwindCSS erstellt,
										und wird auf Vercel gehostet.
									</p>
								</div>
							</div>
						</div>
